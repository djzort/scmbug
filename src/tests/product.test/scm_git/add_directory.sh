...
COMMIT_FILE=test_directory/test_file_in_directory.txt
...
Testing a commit of $COMMIT_FILE of a file in a directory on a bug id with a valid bug owner." $COMMIT_FILE && echo PASSED
