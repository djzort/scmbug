...
$SCM_BIN_PATH/cvs commit -m "${LOG_TEMPLATE_ID_PREFIX}${TESTSUITE_BUG_VALID_BUG_OWNER}${SEPARATOR_TOKEN}${TESTSUITE_BUG_VALID_BUG_OWNER2}${LOG_TEMPLATE_ID_POSTFIX} $TESTSUITE_COMMON_NOTE
