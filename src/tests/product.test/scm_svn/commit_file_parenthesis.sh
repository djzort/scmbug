...
Testing a commit of $COMMIT_FILE on a bug id with a valid bug owner, with the bug number in parenthesis." $COMMIT_FILE || ($SCM_BIN_PATH/svn remove --force $COMMIT_FILE; echo PASSED)
